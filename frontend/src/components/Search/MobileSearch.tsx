      ...
      {isSearchOpen && (
        <div className="z-50 absolute top-0 left-0 w-full h-full bg-[#000000]  items-start pt-3 gap-5">
          ...
          <div className="w-full flex justify-center mt-5">
            <div className="px-3 w-[80%] flex justify-center p-1 rounded-lg bg-[#242423]/50">
              <input
                placeholder="Search"
                className="bg-transparent border-none focus:outline-none placeholder:text-gray-400 focus:placeholder:text-gray-500 transition-all"
              />
            </div>
          </div>
        </div>
